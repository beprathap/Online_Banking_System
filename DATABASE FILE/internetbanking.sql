...
(2, 'System Administrator', 'admin@mail.com', 'iBank-ADM-0516', '0a88299c0602a5a65fcf163f87214901f66d737e', 'admin-icn.png');
...
(3, 'Staff ', 'iBank-STAFF-6785', '0704975742', 'staff@mail.com', '0a88299c0602a5a65fcf163f87214901f66d737e', 'Male', 'user-profile-min.png');
...
CREATE TABLE `ib_transactions` (
  ...
  `client_phone` varchar(200) NOT NULL,
  `receiving_acc_no` varchar(200)  NULL,
  `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `receiving_acc_name` varchar(200) NULL,
  `receiving_acc_holder` varchar(200) NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
